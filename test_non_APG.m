% Test non-convex APG
    ...
    addpath('Non convex');
%% Parameters
    m = 500;                                    % Data dimension
    n = 2500;                                    % Feature dimension
    ...
    init_x = rand(n,1);                        % Initialization
...
%% Plotting
    ...
    legend(['Prox gradient ' num2str(round(PG.time,2)) ' sec'],['Accelerated ' num2str(round(APG.time,2)) ' sec'],...
                ['Monotonic Accelerated ' num2str(round(APG_MON.time,2)) ' sec'],...
                ['Non convex monotonic prox ' num2str(round(nc_APG.time,2)) ' sec'],...
                ['Non convex non monotonic prox ' num2str(round(nc_nAPG.time,2)) ' sec']);
    axis tight;
